...
Dialog {
    ...
    contentItem: Column {
        ...
        Column {
            ...
            Row {
                spacing: 10
                // Drawn rather than loaded: this project carries no branding resource, and one
                // SVG would mean linking Qt6::Svg into a static build for a 34px mark.
                Rectangle {
                    width: 34
                    height: 34
                    radius: 9
