...
// Per-(OS)-user app preferences, persisted as JSON at $HOME/.euclid/amo.json - its own file
// rather than the RUI's: two applications writing one file would each overwrite the other's last
// change, and a monitoring wall pointed at a second installation is a normal thing to want open
// beside a RUI pointed at the first. Same dot
